...
camhfov = 64 #camera horizontal field of view, DEGREES
camvfov = 41 #camera vertical field of view
camxres = 1920 #camera x resolution
camyres = 1080
...
screenWidth = 20.4 #inches
screenHeight = 12.6 #inches
screenResolution = (1920,1200)
userHead = 3100 #user head size scales only distance estimate, adjust this value until distance is correct. There's a print(distance) down there to help with this process, see README file.
